...
export class Quiz4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.arrayOption = this._windowRef.nativeWindow.firstSlideComponentJson.quiz4Options;
    this.answerId = Number(this._windowRef.nativeWindow.firstSlideComponentJson.quiz4Ans);
    let i;
