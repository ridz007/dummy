...
export class Quiz5Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.arrayOption = this._windowRef.nativeWindow.firstSlideComponentJson.quiz5Options;
    this.answerId = Number(this._windowRef.nativeWindow.firstSlideComponentJson.quiz5Ans);
    let i;
