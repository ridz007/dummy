...
export class Quiz2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.arrayOption = this._windowRef.nativeWindow.firstSlideComponentJson.quiz2Options;
    this.answerId = Number(this._windowRef.nativeWindow.firstSlideComponentJson.quiz2Ans);
    let i;
