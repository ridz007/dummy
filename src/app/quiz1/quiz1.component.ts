...
export class Quiz1Component implements OnInit {
  ...
  ngOnInit() {
    ...
    this.arrayOption = this._windowRef.nativeWindow.firstSlideComponentJson.quiz1Options;
    this.answerId = Number(this._windowRef.nativeWindow.firstSlideComponentJson.quiz1Ans);
    let i;
